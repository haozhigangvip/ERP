package com.targetmol.system.exception;
...
public class CustomExceptionCatch extends ErpExcetpion {
    ...
    public ResultMsg exception(Exception exception) {
        ...
        if (resultCode != null) {
            ...
            //返回99999异常
            if(exception.getClass().getName()=="com.targetmol.common.exception.ErpExcetpion")
                return new ResultMsg(((ErpExcetpion) exception).getExceptionEumnumn().getCode(),((ErpExcetpion) exception).getExceptionEumnumn().getMsg());
            else{
